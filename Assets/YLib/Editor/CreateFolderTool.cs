...
namespace YLib.Tools
{
    public class CreateFolderTool
    {
        ...
        {
            // 定義要創建的資料夾名稱
            string[] folderNames = { "0_Scenes","1_Scripts","2_Prefabs","3_Datas","4_Images","5_UI","6_Animations","7_Audios","8_Videos","9_Materials","10_Shaders","11_Fonts","12_Editor","Resources","StreamingAssets"}; // 自定義資料夾名稱
